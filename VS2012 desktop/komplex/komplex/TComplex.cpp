...
TComplex TComplex :: Add(const TComplex &X)
{
	TComplex res;
	res.Re=Re+X.Re;
	res.Im=Im+X.Im;
...
TComplex TComplex :: Sub(const TComplex &C)
{
	TComplex otv;
	otv.Re=Re-C.Re;
	otv.Im=Im-C.Im;
...
TComplex TComplex ::Umn(const TComplex &D)
{
	TComplex res;
...
TComplex TComplex:: Del(const TComplex &R)
{
	TComplex res;
	if((R.Re==0)&&(R.Im==0))
